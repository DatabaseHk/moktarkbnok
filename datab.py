...
class TNscan :
	def __init__(self, serverip) :
		...
		print menu
		while True :
			kaissar = raw_input('\033[31m kaissar  >>> ')
			if kaissar == '1' :
				self.getSites(True)
			elif kaissar == '2' :
				self.getJoomla()
 ...
 >>> Bism Allah <<< 
# >>> M-TECHNOLOGY <<< 
# Code Name : Server Scanning Tool 3
# Coder     : M-TECHNOLOGY 
# Blog      : www.m-technology.ml  
# Twitter   : 
# Pastebin  : www.pastebin.com/u/Falaga_Nasa
...
#              greats also to tunisia M-TECHNOLOGY team and to MTD team and to you !
"""
